...
function EmptyState() {
  return (
    <div className="flex flex-col items-center gap-4 rounded-3xl border border-dashed border-border bg-card/50 px-6 py-12">
      <MascotEmpty
        title="No cats yet"
        description="Your CatDex is empty. Go catch your first stray!"
      />
      <Link href="/catch">
